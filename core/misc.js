  ...
  card.innerHTML = `
    <div class="chv227-hero">
      ...
      <svg class="chv227-illustration chv227-illustration-redesign" viewBox="0 0 160 160" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <defs>
          <linearGradient id="chv-cup-fill" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#173D2A"/><stop offset="1" stop-color="#0F241B"/></linearGradient>
        </defs>
        <g fill="#2F5C44" opacity=".3"><path d="M48 38 H112 V58 C112 81 99 96 80 96 C61 96 48 81 48 58 Z"/></g>
        <path d="M50 46 C28 46 26 80 54 86" stroke="#4ade80" stroke-width="7"/>
        <path d="M110 46 C132 46 134 80 106 86" stroke="#4ade80" stroke-width="7"/>
        <path d="M50 38 H110 V58 C110 80 98 94 80 94 C62 94 50 80 50 58 Z" fill="url(#chv-cup-fill)" stroke="#4ade80" stroke-width="3"/>
        <g stroke="#2F5C44" stroke-width="2.4" opacity=".6"><path d="M64 44 C63 60 66 78 76 90"/><path d="M88 44 C90 60 88 76 80 90"/></g>
        <path d="M58 44 C58 62 62 80 73 90" stroke="#7DE6AB" stroke-width="2.6" opacity=".55"/>
        <path d="M80 94 V112" stroke="#4ade80" stroke-width="7"/>
        <path d="M62 122 C62 116 70 112 80 112 C90 112 98 116 98 122 Z" fill="url(#chv-cup-fill)" stroke="#4ade80" stroke-width="3"/>
        <rect x="58" y="121" width="44" height="9" rx="3" fill="#0F241B" stroke="#4ade80" stroke-width="2.6"/>
        <g fill="#7DE6AB" opacity=".7"><circle cx="120" cy="34" r="2.2"/><circle cx="38" cy="100" r="1.8"/></g>
        <g fill="#4ade80" opacity=".6"><circle cx="44" cy="28" r="1.5"/><circle cx="114" cy="122" r="1.5"/></g>
      </svg>
