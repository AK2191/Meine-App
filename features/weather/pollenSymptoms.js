...
(function(){
  ...
  function symptomIconSvg(key){
    var map = {
      ...
      // Niesen: Profil-Gesicht nach rechts, niest nach rechts (wie Referenzbild)
      // Stirn oben, Nase, Mund/Kinn, dann 3 Luftstrahl-Linien nach rechts mit Punkten
      sneeze:'<span class="change-symptom-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M8 3 Q8.5 3 9 3.5 Q10 5 10 7 Q10 9 9.5 10.5 Q11 11 11 12 Q10.5 13 9 13.5 Q8.5 14.5 8.5 15.5 Q8 16.5 7 17" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M7 17 Q6 17.5 5.5 17" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" fill="none"/><path d="M11 12 L17 10" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M11 12.5 L17.5 12.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M11 13 L17 15" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><circle cx="18.5" cy="10" r="1" fill="currentColor" opacity=".7"/><circle cx="19" cy="12.5" r="1" fill="currentColor" opacity=".65"/><circle cx="18.5" cy="15" r=".9" fill="currentColor" opacity=".55"/></svg></span>',

      // Augen: Auge mit Träne (unverändert, sieht gut aus)
      ...
      // Nase: Seitenansicht wie Referenzbild — schlanke Linie oben, Nasenflügel unten
      nose:'<span class="change-symptom-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M13 2 Q12.5 3 11.5 6 Q10.5 10 10.5 14 Q10.5 17 9 18.5 Q7.5 19.5 7 20 Q7.5 21 9 21 Q10.5 21 11.5 20" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/><path d="M11.5 20 Q13.5 21.5 15 20.5 Q16.5 19.5 16.5 18 Q16.5 17 15.5 16.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg></span>',

      // Atmung: Lunge (unverändert, sieht gut aus)
