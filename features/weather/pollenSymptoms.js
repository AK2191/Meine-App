...
(function(){
  ...
  function symptomIconSvg(key){
    ...
    var map = {
      ...
      // Niesen: Gesicht mit drei Tropfen/Spritzern
      sneeze:'<span class="change-symptom-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="9.5" r="4.5" stroke="currentColor" stroke-width="1.6"/><path d="M9.5 13.5 Q8 17 6.5 18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/><path d="M12 14 Q12 17.5 12 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/><path d="M14.5 13.5 Q16 17 17.5 18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/><circle cx="6" cy="19.5" r="1.2" fill="currentColor" opacity=".7"/><circle cx="12" cy="20" r="1.2" fill="currentColor" opacity=".7"/><circle cx="18" cy="19.5" r="1.2" fill="currentColor" opacity=".7"/></svg></span>',
      ...
      // Nase: klar erkennbare Nasensilhouette von vorne mit Tropfen
      nose:'<span class="change-symptom-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M12 3 Q12 3 12 10 Q12 14 9 16 Q7 17 7 18.5 Q7 20 9 20 L15 20 Q17 20 17 18.5 Q17 17 15 16 Q12 14 12 10 Q12 3 12 3Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><ellipse cx="9" cy="19" rx="2" ry="1" fill="currentColor" fill-opacity=".2"/><ellipse cx="15" cy="19" rx="2" ry="1" fill="currentColor" fill-opacity=".2"/><path d="M12 16 Q12 17.5 12.5 20" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" opacity=".55"/><circle cx="13" cy="20.5" r="1" fill="currentColor" opacity=".6"/></svg></span>',
