## Version 0.1.0308
- Einstellungen geometrisch und typografisch an `Einstellungen Komplett.html` angeglichen: zentrierter 1180px-Wrapper, Referenzabstaende, 236px Nav-Rail, Panel-Padding sowie Profil- und Mitspieler-Proportionen.
- Einstellungen starten jetzt wie die Vorlage im Bereich Profil.
- `openPushSettingsPanel()` leitet wieder direkt zu Benachrichtigungen statt Daten & Sync.
- Keine Aenderung an Firebase, Login, Google Kalender, Push-Logik, Sync, Kalender, Challenges oder Datenmodell. Keine Auto-Starts und keine blockierenden Overlays.
